...
import nerdhub.steampunk.machinery.fluid.CoalGasFluid;
...
public class SteampunkFluids implements AutoRegistryHook {
    ...
    public static final BaseFluid COAL_GAS = new CoalGasFluid();
    public static final BaseFluid COAL_GAS_FLOWING = new CoalGasFluid.Flowing();
}
